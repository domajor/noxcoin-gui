...
ColumnLayout {
    ...
    RowLayout {
        ...
        noxcoinComponents.Label {
            color: lineEdit.inputHasFocus ? noxcoinComponents.Style.defaultFontColor : noxcoinComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        noxcoinComponents.TextPlain {
            ...
            color: wordsMatch ? (noxcoinComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? noxcoinComponents.Style.defaultFontColor : noxcoinComponents.Style.appWindowBorderColor
