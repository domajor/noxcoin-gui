#ifdef __APPLE__
  #define noxcoin_LOCAL_SYMBOL(x) .private_extern x
#else
  #define noxcoin_LOCAL_SYMBOL(x) .hidden x
#endif
...
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
noxcoin_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
