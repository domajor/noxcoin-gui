...
The first audit was generously funded by [Arweave](https://www.arweave.org/), one of the early adopters of RandomX. The remaining three audits were funded by donations from the [noxcoin community](https://ccs.getnoxcoin.org/proposals/RandomX-audit.html). All four audits were coordinated by [OSTIF](https://ostif.org/).
...
RandomX was primarily designed as a PoW algorithm for [noxcoin](https://www.getnoxcoin.org/). The recommended usage is following:
