...
RUN	git clone https://github.com/noxcoin-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/noxcoin-project/noxcoin
...
if [ ! -d sigs ]; then
	git clone https://github.com/noxcoin-project/gitian.sigs.git sigs
	cd sigs
