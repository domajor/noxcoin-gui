...
*Setup instructions for a Gitian build of noxcoin using Docker.*
...
You'll also need to clone the noxcoin repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/noxcoin-project/noxcoin.git
cd noxcoin/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/noxcoin-project/gitian.sigs/) repo on your GitHub account.
