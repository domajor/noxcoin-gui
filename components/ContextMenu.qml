...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: noxcoinComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: noxcoinComponents.Style.blackTheme ? noxcoinComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        noxcoinComponents.ContextMenuItem {
