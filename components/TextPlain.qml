...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? noxcoinComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    noxcoinEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : noxcoinComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : noxcoinComponents.Style._w_defaultFontColor
    }
