...
MenuItem {
    ...
    background: Rectangle {
        color: noxcoinComponents.Style.buttonBackgroundColorDisabledHover
        opacity: 0
    ...
    contentItem: RowLayout {
        ...
        Text {
            ...
            color: noxcoinComponents.Style.buttonTextColor
        ...
        Text {
            color: noxcoinComponents.Style.blackTheme ? noxcoinComponents.Style.buttonTextColor : noxcoinComponents.Style.defaultFontColor
